...
choix_2 = Radiobutton(window, text="base 2",font=("Helvetica", 15),value="base 2",command=from_b2())
choix_10 = Radiobutton(window, text="base 10",font=("Helvetica", 15), value="base 10",command=from_b10())
choix_16 = Radiobutton(window, text="base 16",font=("Helvetica", 15), value="base 16",command=from_b16())
...
'''
choix_2.bind('<button1>',v2=="base 2")
choix_10.bind('<button1>',v2=="base 10")
choix_16.bind('<button1>',v2=="base 16")
...
answer_2 = Radiobutton(window, text="base 2",variable=var_user,font=("Helvetica", 15), value="base 2",command=to_b2())
answer_10 = Radiobutton(window, text="base 10",variable=var_user,font=("Helvetica", 15), value="base 10",command=to_b10())
answer_16 = Radiobutton(window, text="base 16",variable=var_user,font=("Helvetica", 15), value="base 16",command=to_b16())
...
#lance le calcul
bouton_résultat=Button(window, text="►", font=("Helvetica",20), bg='green', fg='black',command=résultat(valeurx,b,tb))

bouton_résultat.grid()

"""
answer_2.bind('<button1>',v3=="2")
answer_10.bind('<button1>',v3=="10")
answer_16.bind('<button1>',v3=="16")


label_résultat= Label(window, text=résultat(var_user,v2,v3))
label_résultat.grid(row=2,column=4)
"""
