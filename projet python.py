...
rectangle(x, y, espacement*6.99, longueur*0.42, 'navy')
...
nlignemetoiles(tailleetoile,espacement,'white',x,y+3,5,6,1)

# etape 4.2 : 4 lignes de 5 etoiles = 20
#ligne5etoiles(tailleetoile,espacement,'white',x,y)
nlignemetoiles(tailleetoile,espacement,'white',x,y+4,4,5,1.8)
