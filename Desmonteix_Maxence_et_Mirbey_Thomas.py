...
def convertir(nombre, basesource, basedestination):
    if basesource == 0 and basedestination == 0 :
        showerror("Error","Il n'y a pas de base source ni de base destination")
    elif basesource == basedestination:
...
# bouton quit
bouton_quit=Button(window, text=" ✕ ", font=("Helvetica", 15), bg='red', fg='white', command=window.destroy)
...
choix_10.grid(pady=4,row=5,sticky='w')
choix_16.grid(pady=3,row=6,sticky='w')
